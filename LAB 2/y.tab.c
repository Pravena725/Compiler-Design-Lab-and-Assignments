...
static const yytype_uint8 yyrline[] =
{
      ...
      42,    59,    76,    77,    78,    79,    83,    96,    97,   100,
     101,   102,   106,   107,   108,   111,   112,   113,   114,   117,
     118,   119,   120,   121,   122,   127,   129,   130,   133,   134,
     135,   139,   140,   143
};
#endif
...
#line 42 "parser.y"
				...
				*/
                    ...
                    for(int i=1;i<type;i++)
                        size *= 2;
                    symbol* sym = allocate_space_for_table_entry(yyvsp[-2], size, type, yylineno, 1);
...
#line 59 "parser.y"
				...
				/*
                    ...
                    for(int i=1;i<type;i++)
                        size *= 2;
                    symbol* sym = allocate_space_for_table_entry(yyvsp[0], size, type, yylineno, 1);
                    insert_into_table(sym);
            }
#line 1459 "y.tab.c"
    break;
